...
public class DefaultGoogleSheetBuilderServiceTests {
    ...
    // The logic here is tested in the character sheet worker tests, but we want to at least
    // confirm that something gets put into the appropriate field in the spreadsheet
    @Test
